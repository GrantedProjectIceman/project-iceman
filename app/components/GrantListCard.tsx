...
export default function GrantListCard({
  ...
  return (
    <Link href={`/grant/${grant.id}`}>
      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-black/5 p-5 hover:shadow-md transition cursor-pointer hover:ring-indigo-200">
        {/* Title + Save button row */}
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h2 className="text-lg font-extrabold text-gray-900 leading-snug hover:text-indigo-600 transition">
              {grant.title}
            </h2>
